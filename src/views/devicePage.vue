<template>
    <div>
        <div>
            <a-button size="small" type="primary" icon="plus" @click="goToAddPage" style="background-color: #42b983;border:none;margin-right: 20px">新增设备</a-button>
            <a-button size="small" type="primary" icon="edit" :disabled="!hasSelected" @click="goToModifyPage" style="background-color: #42b983;border:none;margin-right: 20px">修改设备</a-button>
            <a-button size="small" type="primary" icon="minus" :disabled="!hasSelected" @click="goToDeletePage" style="background-color: #42b983;border:none">删除设备</a-button>
        ...
        <a-button size="small" type="primary" icon="download" @click="exportExcel" style="float:right;margin-right: 10px;background-color: #42b983;border:none">导出设备表</a-button>
        <div id="loadingDiv">
    ...
    export default {
        ...
        methods:{
            ...
            goToAddPage(){
                ...
                this.$router.replace('/addDevicePage'+DateString);
            },
            goToModifyPage(){
                let tempDate= new Date(this.newDate);
                ...
                this.$router.replace({path:'/modifyDevicePage',query:{
                        year:DateYear,
                        month:DateMonth,
                        day:DateDay,
            ...
            goToDeletePage(){
                ...
                this.$router.replace({path:'/deleteDevicePage',query:{
                        year:DateYear,
                        month:DateMonth,
                        day:DateDay,
                        selectedData:this.selectedData
            ...
            exportExcel() {
                ...
                this.$nextTick(function () {
                    ...
                    try {
                        //给xlsx文件赋值名字
                        FileSaver.saveAs(new Blob([wbout], {type: 'application/octet-stream'}), '设备表.xlsx')
                    } catch (e) {
